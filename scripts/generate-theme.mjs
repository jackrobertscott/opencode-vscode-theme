...
const vscodeTheme = {
  ...
  colors: {
    ...
    "editorGutter.addedBackground": c.diffHighlightAdded,
    "editorGutter.background": c.background,
    "editorGutter.deletedBackground": c.diffHighlightRemoved,
    ...
    "gitDecoration.addedResourceForeground": c.diffHighlightAdded,
    "gitDecoration.deletedResourceForeground": c.diffHighlightRemoved,
    ...
    "diffEditor.insertedTextBackground": `${c.diffHighlightAdded}26`,
    "diffEditor.removedTextBackground": `${c.diffHighlightRemoved}26`,
    "diffEditorGutter.insertedLineBackground": `${c.diffHighlightAdded}33`,
    "diffEditorGutter.removedLineBackground": `${c.diffHighlightRemoved}33`,
  ...
  tokenColors: [
    ...
    rule(["markup.inserted", "markup.diff.header.to-file"], c.diffHighlightAdded),
    rule(["markup.deleted", "markup.diff.header.from-file"], c.diffHighlightRemoved),
